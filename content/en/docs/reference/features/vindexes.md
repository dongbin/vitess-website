...
Name | Type | Description | Primary | Multi-column | Reversible | Cost | Data types |
---- | ---- | ----------- | ------- | ------------ | ---------- | ---- | ---------- |
binary | Functional Unique | Identity | Yes | No | Yes | 0 | Any |
binary\_md5 | Functional Unique | MD5 hash | Yes | No | No | 1 | Any |
consistent\_lookup | Lookup NonUnique | Lookup table non-unique values | No | Identify Row | No | 20 | Any |
consistent\_lookup\_unique | Lookup Unique | Lookup table unique values | If unowned | Identify Row | No | 10 | Any |
hash | Functional Unique | DES null-key hash | Yes | No | Yes | 1 | 64 bit or smaller numeric or equivalent type |
lookup | Lookup NonUnique | Lookup table non-unique values | No | Identify Row | No | 20 | Any |
lookup\_unique | Lookup Unique | Lookup table unique values | If unowned | Identify Row | No | 10 | Any |
null | Functional Unique | Always map to keyspace ID 0 | Yes | No | No | 100 | Any |
numeric | Functional Unique | Identity | Yes | No | Yes | 0 | 64 bit or smaller numeric or equivalent type |
...
reverse\_bits | Functional Unique | Bit reversal | Yes | No | Yes | 1 | 64 bit or smaller numeric or equivalent type |
unicode\_loose\_md5 | Functional Unique | Case-insensitive (UCA level 1) MD5 hash | Yes | No | No | 1 | String or binary types |
unicode\_loose\_xxhash | Functional Unique | Case-insensitive (UCA level 1) xxHash64 hash | Yes | No | No | 1 | String or binary types |
